...
constexpr auto qt_meta_stringdata_CLASSPlayListViewENDCLASS = QtMocHelpers::stringData(
    "PlayListView",
    "addFavoiteList",
    "",
    "data",
...
void PlayListView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->addFavoiteList((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->removeFromPlayList((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (PlayListView::*)(const QString & );
            if (_t _q_method = &PlayListView::addFavoiteList; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (PlayListView::*)(int );
            if (_t _q_method = &PlayListView::removeFromPlayList; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void PlayListView::addFavoiteList(const QString & _t1)
{
...
// SIGNAL 1
void PlayListView::removeFromPlayList(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
